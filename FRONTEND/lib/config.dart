class Config {
  ...
  static const String addInformationUserNotification = '/api/users/firebase/addInformation';
  static const String removeInformationUserNotification = '/api/users/firebase/removeInformation';
}
